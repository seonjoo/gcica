...
```{r Group cICA dwst example with random time series, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
N = 128
M = 2
...
male = list(
 # rbind(
 #    arima.sim(list(order=c(0,0,1), ma=0.5),N),
 #    arima.sim(list(order=c(0,0,2), ma=c(1,0,0.25)),N)),
 # rbind(
 #    arima.sim(list(order=c(0,0,1), ma=0.5),N),
 #    arima.sim(list(order=c(0,0,2), ma=c(1,0,0.25)),N)),
 # rbind(
 ...
 #    arima.sim(list(order=c(0,0,2), ma=c(1,0,0.25)),N))
  rbind(
    arima.sim(list(order=c(1,0,0), ar=0.5),N),
    arima.sim(list(order=c(1,0,0), ar=-0.5),N)),
  rbind(
    arima.sim(list(order=c(1,0,0), ar=0.5),N),
    arima.sim(list(order=c(1,0,0), ar=-0.5),N)),
